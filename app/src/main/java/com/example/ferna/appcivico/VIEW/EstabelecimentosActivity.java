...
import com.example.ferna.appcivico.JSON.IEstabelecimentoJSON;
import com.example.ferna.appcivico.R;
import com.example.ferna.appcivico.StatusClass;
...
public class EstabelecimentosActivity extends AppCompatActivity {
    ...
    private void carregaListaEstabelecimentos(List<Estabelecimento> listaEstabelecimentos) {
        ...
        txtTotalResultados.setText(String.valueOf(listaEstabelecimentos.size() + " "));
    }

//    private void buscaEstabelecimentoJson() {
...
//
//        Call<List<Estabelecimento>> listaRequest = jsonEstabelecimentos.listaEstabelecimentos();
//
//
    ...
    public void callAcessLocation() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                callDialog("É necessário habilitar as permissões para utilizar o App.", new String[]{Manifest.permission.ACCESS_FINE_LOCATION});
            } else {
